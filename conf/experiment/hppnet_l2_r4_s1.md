---
experiment: hppnet_l2_r4_s1
training_config: conf/experiment/hppnet_l2_r4_s1.yaml
...
Review experiment B: hppnet L2, seed 1, real-data fine-tuning.
Matched counterpart: `hppnet_l3_r4_s1`. Warm-starts only from `hppnet_l2_comb_s1`; uses the frozen real development split.

---
experiment: hppnet_l3_r4_s0
training_config: conf/experiment/hppnet_l3_r4_s0.yaml
...
Review experiment B: hppnet L3, seed 0, real-data fine-tuning.
Matched counterpart: `hppnet_l2_r4_s0`. Warm-starts only from `hppnet_l3_comb_s0`; uses the frozen real development split.

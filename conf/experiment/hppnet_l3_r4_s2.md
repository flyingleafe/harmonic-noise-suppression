---
experiment: hppnet_l3_r4_s2
training_config: conf/experiment/hppnet_l3_r4_s2.yaml
...
Review experiment B: hppnet L3, seed 2, real-data fine-tuning.
Matched counterpart: `hppnet_l2_r4_s2`. Warm-starts only from `hppnet_l3_comb_s2`; uses the frozen real development split.

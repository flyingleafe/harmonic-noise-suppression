---
experiment: nv2_easy_hppnet_l2
training_config: conf/experiment/nv2_easy_hppnet_l2.yaml
...
`decode_logits`) on the noise-model-v2 **EASY** stream — the easy arm of the
...
**5.37**; and the same-stream arm of the other trunk (`nv2_easy_scv2`), which
...
checkpoint — `python scripts/_regime_decomp.py --exp nv2_easy_hppnet_l2 --ckpt
...
```bash
scripts/noise_v2_submit_arms.sh nv2_easy_hppnet_l2
```

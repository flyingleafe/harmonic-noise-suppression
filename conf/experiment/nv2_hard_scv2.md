---
experiment: nv2_hard_scv2
training_config: conf/experiment/nv2_hard_scv2.yaml
...
on the noise-model-v2 **HARD** stream — the hard arm of the fitted-family
...
(`nv2_hard_hppnet_l2`), which is what separates "this noise family transfers"
...
checkpoint — `python scripts/_regime_decomp.py --exp nv2_hard_scv2 --ckpt best`

...
# MOVED to data_processing.noise_model.resample so the v2 renderer can read the
# render chain's anti-alias filter without importing experiments; names,
# signatures and values unchanged, and re-exported from here.
from data_processing.noise_model.resample import (
    AA_PASS_HZ,
    AA_RIPPLE_DB,
    AA_STOP_DB,
    AA_STOP_HZ,

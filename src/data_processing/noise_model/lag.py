...
level of the forward model: :mod:`experiments.noise_model.spectrum` hands it to the same
finite-window kernel C4 uses, and :mod:`.render` draws the processes it
describes. Keeping it
...
from data_processing.noise_model.ou import integrated_ou_increment_var

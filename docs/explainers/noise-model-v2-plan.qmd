...
- **The path term.** Per microphone, shared across rotors, `∝ f`. Proposal:
  not fitted in R1 (no evidence of that signature); admitted only if a round
  fails with a mic-common, frequency-proportional phase residual. Decide.

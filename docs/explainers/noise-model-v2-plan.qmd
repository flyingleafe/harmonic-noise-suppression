...
| DREGON room2 free flight | free flight, label error ~1 Hz std at `k = 70` | `motors_command` | — | — | **not fitted**; evaluation support only |
...
Seven choices are open. Each one has a proposal and the number behind it.

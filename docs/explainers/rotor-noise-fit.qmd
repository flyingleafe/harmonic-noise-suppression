...
Round 2 C2 is implemented in commit `08b8ef3c` and remote preflight
`revised-phase-round2-pro-db69c3` passed 39 tests with 2 skipped in 56.72 s.
Real DREGON/Michael fitting and frozen evaluation are authorized and running
elsewhere; no revised candidate has been scored or accepted in this historical
page.

...
| proxy `ltas_abs_db` michaels_cruise | FAIL | 2.1599 dB (spread 1.5399) | <= 1.2197 dB |
| likelihood comb (decisive) | FAIL | model -348,413.8970 nats/s | oracle -371,916.5041, margin +23,502.6071 |
| likelihood floor | report | model -6,994.5298 nats/s | oracle -8,713.2663, margin +1,718.7366 |
| likelihood full | report | model -355,408.4267 nats/s | oracle -380,629.7704, margin +25,221.3437 |
...
|---|---|---:|---:|---:|---:|
| michaels_cruise | `FLY124@40.000000+8.000000` | 1.3900 | 2.9035 | 1.6643 | +1.0999 |
| michaels_cruise | `FLY124@56.000000+8.000000` | 2.9299 | 3.4433 | 2.6029 | +2.9299 |
...
michaels_cruise: mean 2.1599 dB (spread 1.5399 over 2 supports) against the closure-0.7 gate 1.2197 dB = 1.5333 - 0.7 x (1.5333 - 1.0852); margin -0.9403 dB. Secondary `mr_ltas` 2.1336 dB (reported, never decisive).
...
|---|---|---:|---:|---:|---|
| comb | 300-7900 | -348,413.8970 | -371,916.5041 | +23,502.6071 | False |
| floor | 30-300 | -6,994.5298 | -8,713.2663 | +1,718.7366 | False |
| full | 30-7900 | -355,408.4267 | -380,629.7704 | +25,221.3437 | False |

Frozen comb-band margin: +23,502.6071 nats/s (R1 freezes the comb-band model-minus-oracle margin; later rounds are held to it).

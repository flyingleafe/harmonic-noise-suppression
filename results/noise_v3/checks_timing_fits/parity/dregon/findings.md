...
|---|---|---|---|
| HPPNet DREGON cruise | FAIL | 1.784241 rev/s (95 % upper 2.100938) | <= 1.897063 |
| HPPNet Michael's ratio | NOT RUN | no FLY124 support measured (5 missing) | <= 1.05 (3.177994 rev/s) |
| proxy `ltas_abs_db` dregon_cruise | FAIL | 2.6866 dB (spread 3.1191) | <= 1.9786 dB |
...
|---|---|---|---:|---:|---:|
| dregon | `free-flight_nosource_room2@1512727397.205045+4.000000` | cruise | 0.638129 | 1.364047 | 0.411449 |
| dregon | `hovering_nosource_room2@1511903905.394490+4.000000` | cruise | 0.888408 | 1.635784 | 0.360816 |
| dregon | `updown_nosource_room2@1511903578.348311+4.000000` | cruise | 1.694930 | 1.946660 | 0.304686 |
| dregon | `rectangle_nosource_room2@1511905725.952559+4.000000` | cruise | 1.685142 | 2.246082 | 0.237501 |
| dregon | `spinning_nosource_room2@1511905200.978012+4.000000` | cruise | 1.186931 | 1.728634 | 0.333213 |

DREGON cruise: candidate mean 1.784241 rev/s over 5 recording-level clusters, one-sided 95 % interval [1.467545, 2.100938] (t and 20000-draw cluster bootstrap, conservative), against the frozen target 1.897063 = 1.218708 + 0.7 x (2.187786 - 1.218708). Margin 0.112821 rev/s.

Real arm reproduction: measured 1.218708 rev/s against the frozen 1.218708 (relative 1.807e-08).
...
|---|---|---:|---:|---:|---:|
| dregon_cruise | `free-flight_nosource_room2@1512727397.205045+4.000000` | 3.2344 | 2.9380 | 3.5598 | -3.2344 |
| dregon_cruise | `hovering_nosource_room2@1511903905.394490+4.000000` | 2.6967 | 2.5518 | 1.7757 | -2.6967 |
| dregon_cruise | `updown_nosource_room2@1511903578.348311+4.000000` | 4.5749 | 2.8905 | 3.7433 | -4.5749 |
| dregon_cruise | `rectangle_nosource_room2@1511905725.952559+4.000000` | 1.4557 | 0.9947 | 1.7889 | -0.7481 |
| dregon_cruise | `spinning_nosource_room2@1511905200.978012+4.000000` | 1.4715 | 1.6820 | 1.4916 | -1.4715 |

dregon_cruise: mean 2.6866 dB (spread 3.1191 over 5 supports) against the closure-0.7 gate 1.9786 dB = 2.4308 - 0.7 x (2.4308 - 1.7848); margin -0.7080 dB. Secondary `mr_ltas` 2.4719 dB (reported, never decisive).

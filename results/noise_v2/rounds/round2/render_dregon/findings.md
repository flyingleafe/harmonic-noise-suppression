...
Record `results/noise_v2/rounds/round2/render_dregon/render_dregon.json`, git `3042c713f4d8cc3f86bcc42cdcf0d3c67a506f29`, fit `results/noise_v2/rounds/round2/fits/dregon_room2_floor__flight_floor_only.json` (mode `flight_floor_only`, `converged` None — NOT converged; amp_exp 0.0000, floor_exp 13.0041, floor_static_rel 0.4690, floor_mean_db -38.097, floor_tilt -8.359 dB/oct), render seed 2001, 8 mics.
...
| `v2_comb_bench_ratio` | 28.784 | 32.364 | H3, comb side: restore the ratio the frozen comb was fitted under |
...
| `v2_comb_bench_ratio` | +38.22 | 28.784 | 32.364 |

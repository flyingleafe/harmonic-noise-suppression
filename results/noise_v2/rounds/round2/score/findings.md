...
Top-level pass (legacy parity on both HPPNet gates): **false**. Stretch (frozen 0.70-gap DREGON target): **false**. All three frozen gates: **false**. Record `results/noise_v2/rounds/round2.json`, git `9579ca94592c`.
...
| `dregon_v2_r2_floor_combgain` | dregon | `results/noise_v2/rounds/round2/fits/dregon_room2_floor__flight_floor_only_v2.json` | **NO** (none, |grad| 1230) | 5905 | `nv2-r2-score-dregon-v2b--bce8f6` |
...
|---|---|---:|---:|---|---:|---|
| dregon | five-recording cruise PIT MAE mean, one-sided 95 % upper bound beside it | 72.340606 | 2.187786 | **FAIL** (margin -70.152820) | 1.897063 | **FAIL** (margin -70.443543) |
...
|---|---|---:|---:|---:|---|---|
| dregon cruise PIT MAE (5-recording mean) | rev/s | 78.803342 | 72.340606 | -6.462736 | lower is better | **better** |
| dregon cruise PIT MAE (95 % upper) | rev/s | 79.482310 | 74.830651 | -4.651659 | lower is better | **better** |
...
| proxy ltas_abs_db, dregon cruise | dB | 3.7518 | 3.5024 | -0.2494 | lower is better | **better** |
| proxy ltas_abs_db, michaels cruise | dB | 1.4156 | 2.1491 | +0.7335 | lower is better | **worse** |
| mr_ltas, dregon cruise (report-only) | — | 2.6359 | 2.5833 | -0.0527 | lower is better | **better** |
...
| `dregon_v2_r2_floor_combgain` | 72.340606 rev/s (95 % upper 74.830651) | 3.5024 (1.9786) | 2.5833 | not run |
| `dregon_v2_r2_floor_benchcomb` | 75.093968 rev/s (95 % upper 75.551936) | 3.6328 (1.9786) | 2.6285 | not run |

Rendered audio of `dregon_v2_r2_floor_combgain` (uncommitted): `s3://omnirun-artifacts/nv2-r2-score-dregon-v2b--bce8f6/outputs/results/noise_v2/rounds/round2/render/audio/dregon_v2b` (job `nv2-r2-score-dregon-v2b--bce8f6`, written to `results/noise_v2/rounds/round2/render/audio/dregon_v2b` in the job's worktree).
...
|---|---|---|---|
| HPPNet DREGON cruise | FAIL | 72.340606 rev/s (95 % upper 74.830651) | <= 1.897063 |
...
| proxy `ltas_abs_db` dregon_cruise | FAIL | 3.5024 dB (spread 3.3462) | <= 1.9786 dB |
...
DREGON cruise: candidate mean 72.340606 rev/s over 5 recording-level clusters, one-sided 95 % interval [69.850561, 74.830651] (t and 20000-draw cluster bootstrap, conservative), against the frozen target 1.897063 = 1.218708 + 0.7 x (2.187786 - 1.218708). Margin -70.443543 rev/s.
...
| dregon_cruise | `free-flight_nosource_room2@1512727397.205045+4.000000` | 4.1541 | 0.0275 | 3.8068 | -4.1541 |
| dregon_cruise | `hovering_nosource_room2@1511903905.394490+4.000000` | 3.6151 | 0.0322 | 1.9698 | -3.6151 |
| dregon_cruise | `updown_nosource_room2@1511903578.348311+4.000000` | 5.2677 | 0.0134 | 3.8226 | -5.2677 |
| dregon_cruise | `rectangle_nosource_room2@1511905725.952559+4.000000` | 1.9215 | 0.0627 | 1.8356 | -1.5633 |
| dregon_cruise | `spinning_nosource_room2@1511905200.978012+4.000000` | 2.5539 | 0.0676 | 1.4814 | -2.5132 |
...
dregon_cruise: mean 3.5024 dB (spread 3.3462 over 5 supports) against the closure-0.7 gate 1.9786 dB = 2.4308 - 0.7 x (2.4308 - 1.7848); margin -1.5238 dB. Secondary `mr_ltas` 2.5833 dB (reported, never decisive).
...
* `michaels_v2_r2_all` — fit git `643b3058c81c`, render/probe job `nv2-r2-score-michaels-kg-86343e`, arm record `results/noise_v2/rounds/round2/render/arm_michaels_v2.json`, render wall 332 s.
* `dregon_v2_r2_floor_combgain` — fit git `643b3058c81c`, render/probe job `nv2-r2-score-dregon-v2b--bce8f6`, arm record `results/noise_v2/rounds/round2/render/arm_dregon_v2b.json`, render wall 164 s.
* `dregon_v2_r2_floor_benchcomb` — fit git `fc18285faea7`, render/probe job `nv2-r2-score-dregon-3f8397`, arm record `results/noise_v2/rounds/round2/render/arm_dregon_v2.json`, render wall 127 s.
